...
<article>
                ...
                <h2>Thêm Thông Tin</h2><br>
                <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="addon-wrapping" >Tên Nhà Hàng</span>
                    </div>
                    <input type="text" class="form-control" placeholder="Tên Sản Phẩm" name="tennh" aria-label="Tên Sản Phẩm" aria-describedby="addon-wrapping">
                </div><br>
                ...
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" class="form-control" placeholder="Tên Sản Phẩm" name="diachi" aria-label="Tên Sản Phẩm" aria-describedby="addon-wrapping">
                </div><br>
                <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="addon-wrapping">Giá thấp nhất</span>
                    </div>
                    <input type="text" class="form-control" placeholder="Giá " name="giathapnhat" aria-label="Giá " aria-describedby="addon-wrapping">
                </div><br>
                <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="addon-wrapping">Giảm cao nhất</span>
                    </div>
                    <input type="text" class="form-control" placeholder="Giảm Giá" name="giacaonhat" aria-label="Giảm Giá" aria-describedby="addon-wrapping">
                </div><br>
                <br>
                 <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" placeholder="view" name="view" aria-label="view" aria-describedby="addon-wrapping">
                </div>
                <br>
                 <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <br>
                 <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        ...
                        <div id="sample">
                            <textarea name="mota" cols="220" class="ha">
                </textarea>
                        </div>
                    </div>
                </div>
