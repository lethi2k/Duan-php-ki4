...
<article>
                ...
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" class="form-control" placeholder="Tên Sản Phẩm" name="tieude" aria-label="Tên Sản Phẩm" aria-describedby="addon-wrapping">
                </div><br>
                ...
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" class="form-control" name="mota" aria-label="Giá " aria-describedby="addon-wrapping">
                </div><br>
                <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="addon-wrapping">Địa Chỉ</span>
                    </div>
                    <input type="text" class="form-control" name="diachi" aria-label="Giảm Giá" aria-describedby="addon-wrapping">
                </div><br>
                <br>
                   <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <br>
                  <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        ...
                        <div id="sample">
                            <textarea name="chitiet" cols="210" class="ha">
                </textarea>
                        </div>
                    </div>
                </div>
